...
function AdminPage() {
  ...
  const submitBan = async () => {
    ...
    if (banDuration === "permanent") {
      ...
      const days =
        banDuration === "custom"
          ? Math.max(1, parseInt(customDays || "1", 10))
          : parseInt(banDuration, 10);
    ...
    <div>
      ...
      <div className="container mx-auto px-4 py-12 max-w-6xl">
        ...
        <p className="text-muted-foreground mb-8">
          Review reports, ban abusers, manage active bans.
        </p>
                ...
                {reports.map((r) => (
                  <tr key={r.id} className="border-t border-border/50">
                    ...
                    <td className="p-3">
                      ...
                      {r.custom_reason && (
                        <div className="text-xs text-muted-foreground">{r.custom_reason}</div>
                      )}
                    </td>
                    <td className="p-3">
                      {r.reviewed ? (
                    ...
                    <td className="p-3 space-x-2">
                      <Button
                        ...
                        onClick={() => openBanDialog(r.reported_user_id, r.id)}
                      >
                ...
                {bans.map((b) => {
                  ...
                  return (
                    <tr key={b.id} className="border-t border-border/50">
                      ...
                      <td className="p-3">
                        {active && (
                          <Button size="sm" variant="outline" onClick={() => liftBan(b.id)}>
                            Lift
                          </Button>
                        )}
                      </td>
      ...
      <Dialog
        open={banDialog.open}
        onOpenChange={(o) => !o && setBanDialog({ open: false, userId: null, fromReportId: null })}
      >
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              <span className="font-semibold">
                {banDialog.userId ? userLabel(banDialog.userId) : ""}
              </span>
              . They'll see this reason next time they sign in.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
            <div>
              ...
              <Textarea
                ...
                placeholder="e.g. Harassment of other users"
              />
            </div>
            <div>
          ...
          <DialogFooter>
            <Button
              variant="ghost"
              onClick={() => setBanDialog({ open: false, userId: null, fromReportId: null })}
            >
              Cancel
            </Button>
